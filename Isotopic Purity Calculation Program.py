...
def run(a=None, b=None, c=None, d=None, e=None, f=None, m=None):
    path = "data.xlsx"
...
if __name__ == '__main__':
    try:
        a = input('Please enter the number of completely labeled 13C atoms：\n')
        b = input('Please enter the number of non-labeled C atoms：\n')
        c = input('Please enter the number of completely labeled D atoms：\n')
        d = input('Please enter the number of non-labeled H atoms：\n')
        e = input('Please enter the number of completely labeled 15N atoms：\n')
        f = input('Please enter the number of non-labeled N atoms：\n')
        m = input('Please enter the m/z value of the completely labeled representative isotopolog ion：\n')
        a = int(a)
        b = int(b)
        c = int(c)
        d = int(d)
